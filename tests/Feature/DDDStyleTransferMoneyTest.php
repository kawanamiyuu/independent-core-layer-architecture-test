...
class DDDStyleTransferMoneyTest extends TestCase
{
    ...
    public function transfer_money()
    {
        ...
        $response = $this->put('/api/accounts/A0001/ddd-transfer', [
    ...
    public function transfer_lack_source_balance()
    {
        ...
        $response->assertStatus(400);
        $response->assertJson(['message' => 'TransferMoneySpec is not satisfied.']);
    }
}

final class DDDStyleTransferMoneyTestSeeder extends Seeder
{
